...
Replace this section with the supported versions for `agentinbox`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `agentinbox` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in agentinbox.
